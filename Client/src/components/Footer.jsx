...
// A simple component for social media icons
      ...
      <div className="w-[90%] mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <h2 className="text-2xl font-bold text-white">Learnzy</h2>
            <p className="mt-2 text-gray-400 text-sm">
              Connecting students with affordable, reliable tutors.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link to="/tutions" className="text-gray-400 hover:text-white transition-colors">Find Tutors</Link></li>
            </ul>
          </div>

          {/* For Tutors */}
          <div>
            <h3 className="text-sm font-semibold tracking-wider uppercase text-gray-300">For Tutors</h3>
            <ul className="mt-4 space-y-2">
              <li><Link to="/teacher-register" className="text-gray-400 hover:text-white transition-colors">Register as Tutor</Link></li>
              <li><Link to="/login" className="text-gray-400 hover:text-white transition-colors">Tutor Login</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="text-gray-400">contact@learnzy.com</li>
